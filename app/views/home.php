...
<body>
    ...
    <div class="hero">
        <div class="hero-container">
            ...
            <div class="hero-card">
                <img src="https://cdn.prod.website-files.com/6890fbf29f28b7089b169c21/6891ed3ee3d93ad17e2c0430_hero-product.jpg">
    ...
    <section class="features">
        <div class="feature-item">
            <div class="feature-icon"><img src="<?= BASE_URL ?>/assets/images/icons/6892144f750bf17c33b635e7_recycling-reproducing-svgrepo-com 1.svg" alt=""></div>
        ...
        <div class="feature-item">
            <div class="feature-icon"><img src="<?= BASE_URL ?>/assets/images/icons/689214509e45233c0eac2f63_warranty-svgrepo-com 1.svg" alt=""></div>
            <h3 class="feature-title">Warranty Included</h3>
            <p class="feature-text">Every pair comes with a hassle-free 6-month warranty</p>
        </div>
        <div class="feature-item">
            <div class="feature-icon"><img src="<?= BASE_URL ?>/assets/images/icons/68921450b524ed88c4868689_delivery-fast-svgrepo.svg" alt=""></div>
            <h3 class="feature-title">Delivery & Shipping</h3>
            <p class="feature-text">Your shoes will be dispatched within 1–2 business days</p>
        </div>
        <div class="feature-item">
            <div class="feature-icon"><img src="<?= BASE_URL ?>/assets/images/icons/6892144f566712d4d864a312_eco-friendly-svgrepo-com 1.svg" alt=""></div>
            ...
            <?php foreach ($products as $product): ?>
                <div class="product-seller">
                    ...
                    <div class="price">
                        ...
                        <span class="old-price"><del>$<?php echo number_format($product["price"], 0, ",", "."); ?></del></span>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
    ...
    <div class="form-slide">
        <div class="slider">
            <div class="slides">
                <img src="<?= BASE_URL ?>/assets/images/banners/689f6c65381608ffd59aca70_Offer-Frame-one.png" class="slide">
                <img src="<?= BASE_URL ?>/assets/images/banners/689f6c65aacca81a46e142c0_Offer-Frame-two.png" class="slide">
                <img src="<?= BASE_URL ?>/assets/images/banners/689f6c65b2cc4aa2b920c790_Offer-Frame-three.png" class="slide">
            </div>
        </div>
    </div>
