...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style_main/style.css">
...
<body>
    ...
    <section class="features">
        ...
        <div class="feature-item">
            <div class="feature-icon"><img
                    src="./assets/images/icons/6892144f750bf17c33b635e7_recycling-reproducing-svgrepo-com 1.svg" alt="">
            </div>
        ...
        <div class="feature-item">
            <div class="feature-icon"><img
                    src="./assets/images/icons/689214509e45233c0eac2f63_warranty-svgrepo-com 1.svg" alt="">
            </div>
        ...
        <div class="feature-item">
            <div class="feature-icon"><img
                    src="./assets/images/icons/68921450b524ed88c4868689_delivery-fast-svgrepo.svg" alt="">
            </div>
        ...
        <div class="feature-item">
            <div class="feature-icon"><img
                    src="./assets/images/icons/6892144f566712d4d864a312_eco-friendly-svgrepo-com 1.svg" alt="">
            </div>
    ...
    <div class="products-container">
        ...
        ?>
            <div class="product-seller">
                ...
                <div class="price">
                    <span>$<?php echo number_format($row["discount_price"],0,",","."); ?></span>
                    <span class="old-price"><del>$<?php echo number_format($row["price"],0,",","."); ?></del></span>
                </div>
            </div>
            <?php
        }
    ...
    <div class="form-slide">
        <div class="slider">
            <div class="slides">
                <img src="./assets/images/banners/689f6c65381608ffd59aca70_Offer-Frame-one.png" class="slide">
                <img src="./assets/images/banners/689f6c65aacca81a46e142c0_Offer-Frame-two.png" class="slide">
                <img src="./assets/images/banners/689f6c65b2cc4aa2b920c790_Offer-Frame-three.png" class="slide">
            </div>
        </div>
    </div>
